...
>
> Absorbed in wave **M2** (2026-08-28) of the estate's service-merge sequence.
>
> **The canonical source is [`micro-agora`](https://github.com/cloudsforge-online/micro-agora)
> at [`src/activity/notify/`](https://github.com/cloudsforge-online/micro-agora/tree/main/src/activity/notify).
...
> It arrived there in two steps: M2 merged it into `activity`, and `activity` itself became a module of `agora` later in the sequence. The nesting is preserved — the source sits at `src/activity/notify`, one level deeper than the modules that moved directly.
>
>
